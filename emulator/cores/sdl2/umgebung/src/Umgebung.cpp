...
int main(int argc, char* argv[]) {
    ...
    // TODO pass arguments to `umgebung::run_application()` maybe with callback `arguments(vector<string> args)`
    if (argc > 1) {
        std::cerr << "WARNING arguments are currenlty not passed to sketch" << std::endl;
